...
For most, the startux image is what you should use for your installation. 
...
stratux release, if want to run the bleeding edge stratux code comment out
the checkout line in the stratux-setup.sh file:  git checkout v0.8r1
